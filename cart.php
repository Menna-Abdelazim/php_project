...
{
    $quantityOfProducts = ["quantityProducts"=>$_POST['quantity']];
    $productCart=$_SESSION['adminProducts'][$index];

    $finalCart =array_merge($productCart, $quantityOfProducts);

    if(!isset($_SESSION['userCart']))
    {
        $_SESSION['userCart']=[];
    }
    array_push($_SESSION['userCart'],$finalCart);
